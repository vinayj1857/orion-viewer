...
//* Time: 18:57
//*/
//public class TouchAutomata2 extends TouchAutomata {
//
...
//
//    public TouchAutomata2(OrionViewerActivity activity, OrionView view, boolean moveOnPinchZoom) {
//        super(activity, view, moveOnPinchZoom);
...
//
//        gestureDetectorCompat = new GestureDetectorCompat(activity, this.new MyGestureListener());
//    }
//
...
//        }
//
//        private void doAction(MotionEvent e, boolean isLongClick) {
//            Common.d("Check event action " + e.getAction() + " " + isLongClick);
//
//            int width = getView().getWidth();
//            int height = getView().getHeight();
//
//            int i = (int) (3 * e.getX() / height);
//            int j = (int) (3 * e.getY() / width);
//
//            int code = activity.getGlobalOptions().getActionCode(i, j, isLongClick);
//            activity.doAction(code);
//        }
